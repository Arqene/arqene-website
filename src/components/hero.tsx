...
const SLIDE_INTERVAL = 4000; // 5 seconds
...
export default function LuxuryHeroWithDiscover() {
  ...
  return (
    <main className="w-full">
      ...
      {/* DISCOVER COMPANY SECTION (updated & properly centered) */}
      <section className="w-full bg-[#f4f4f5] py-10 flex items-center justify-center">
