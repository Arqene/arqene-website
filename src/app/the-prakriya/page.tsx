...
export default function ThePrakriyaPage() {
  return (
    <main className="min-h-screen w-full bg-[#f4f4f5] py-20 lg:py-24">
      <div className="mx-auto max-w-5xl lg:max-w-6xl px-6 lg:px-10">
        {/* Heading */}
        <header className="mb-16 text-left font-futura">
          <h1 className="text-3xl md:text-4xl lg:text-5xl tracking-[0.18em] uppercase text-[#2f2a25]">
            The{" "}
            <span className="text-[#c1171a]">प्र</span>
            <span className="text-[#2f2a25]">kriya</span>
          </h1>
            ...
            return (
              ...
              >
                ...
                <div className="mb-2 flex justify-center md:hidden">
                  <span className="font-futura text-4xl font-semibold tracking-[0.25em] text-black">
                    {step.id}
                  </span>
                </div>
                ...
                <div className="hidden md:flex md:w-24 lg:w-28 justify-center">
                  <span className="self-center font-futura text-4xl md:text-5xl font-semibold tracking-[0.25em] text-black">
                    {step.id}
                  </span>
                </div>
                ...
                <div
                  ...
                  "
                >
                  <h2 className="font-luxury text-2xl md:text-3xl text-[#2f2a25] mb-4">
                    {step.title}
                  </h2>

                  <div className="space-y-3 font-futura text-sm md:text-base leading-relaxed text-[#625b50]">
                    {step.body.map((paragraph, i) => (
                      <p key={i}>{paragraph}</p>
                    ))}
                  </div>

                  <div className="mt-5 font-futura space-y-1 text-xs md:text-sm font-semibold tracking-[0.16em] uppercase text-[#494238]">
                    <p>{step.timeline}</p>
                    <p>{step.deliverable}</p>
                  </div>
                </div>
